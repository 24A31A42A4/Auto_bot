        ...
        <div className="glass p-10 pt-20 pb-12 rounded-[3.5rem] border-white/10 relative overflow-hidden shadow-2xl flex flex-col items-center">
          ...
          >
            ...
            <div className="pt-6">
              <button
                type="submit"
                className="w-full h-14 bg-white text-black text-sm font-black uppercase tracking-widest shadow-2xl rounded-2xl hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2"
                disabled={loading}
              >
                {loading ? (
                  <>
